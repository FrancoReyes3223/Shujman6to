...
export default function Sidebar({ activeTab, setActiveTab, isOpen, setIsOpen }: SidebarProps) {
  ...
  const accountItems = [
    ...
    { id: "seguridad",  label: t("sidebar_security",   "Security"),   icon: Icons.security,   comingSoon: false },
  ...
  return (
    <>
      <div className={`dashboard-sidebar ${isOpen ? "open" : "closed"}`}>
        ...
        {/* Header */}
        <div className="sidebar-header" style={{ justifyContent: isOpen ? "flex-end" : "center" }}>
